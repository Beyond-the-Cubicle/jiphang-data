...
import { OriginalSeoulBusRouteInfo, BusRouteInfo } from "@prisma/client";

export const findManyOriginalSeoulBusRouteInfo = async (): Promise<OriginalSeoulBusRouteInfo[]> => {
    return await prisma.originalSeoulBusRouteInfo.findMany();
}
